...
class User_Register:
    def __init__(self,root):
        ...
        self.root.iconbitmap('C:/Users/User pc/Documents/Mini Project/button images/Iconinv.ico')

                      ##DESIGN#######  

        self.bg= ImageTk.PhotoImage(Image.open("C:/Users/User pc/Documents/Mini Project/button images/og bacground.jpg"))
        bg= Label(self.root,image=self.bg)
        bg.place(x=0,y=0,relwidth=1,relheight=1)
        self.login_b=ImageTk.PhotoImage(Image.open("C:/Users/User pc/Documents/Mini Project/button images/button_login (2).png"))
        log_btn=Label(self.root,image=self.login_b)
        log_btn.place(x=175, y=550, height = 68, width = 250)
        self.regs_b=ImageTk.PhotoImage(Image.open("C:/Users/User pc/Documents/Mini Project/button images/button_register.png"))
        ...
        usrnew_1st = Label(self.usrn_frame, text = "First Name     : ",font =("Arial",16),bg="light goldenrod").grid(row = 1, column = 0, padx = 10, pady = 10)
        self.usrnew_1sten = Entry(self.usrn_frame, width = 40, font =("Arial",16))
        self.usrnew_1sten.grid(row = 1, column = 1, padx = 10, pady = 10)
        usrnew_last = Label(self.usrn_frame, text = "Last Name     : ",font =("Arial",16),bg="light goldenrod").grid(row = 2, column = 0, padx = 10, pady = 10)
        self.usrnew_lasten = Entry(self.usrn_frame, width = 40, font =("Arial",16))
        self.usrnew_lasten.grid(row = 2, column = 1, padx = 10, pady = 10)
        usrnew_id = Label(self.usrn_frame, text = "E-mail id        : ", font =("Arial",16),bg="light goldenrod").grid(row = 3, column = 0, padx = 10, pady = 10)
        self.usrnew_iden = Entry(self.usrn_frame, width = 40, font =("Arial",16))
        self.usrnew_iden.grid(row = 3, column = 1, padx = 10, pady = 10)
        usrnew_pass = Label(self.usrn_frame, text = "Password      : ", font =("Arial",16),bg="light goldenrod").grid(row = 6, column = 0, padx = 10, pady = 10)
        ...
        security = Label(self.usrn_frame, text = "Security Que : ", font =("Arial",16),bg="light goldenrod").grid(row = 4, column = 0, padx = 10, pady = 10)
        ...
        answer = Label(self.usrn_frame, text = "Answer         : ", font =("Arial",16),bg="light goldenrod").grid(row = 5, column = 0, padx = 10, pady = 10)
        self.answeren = Entry(self.usrn_frame, width = 40, font =("Arial",16))
        self.answeren.grid(row = 5, column = 1, padx = 10, pady = 10)
        usrnew_passcn = Label(self.usrn_frame, text = "Confirm Pass : ", font =("Arial",16),bg="light goldenrod").grid(row = 7, column = 0, padx = 10, pady = 10)
