...
###################DESIGN##################
        self.bg= ImageTk.PhotoImage(Image.open("C:/Users/User pc/Documents/Mini Project/button images/Bground.jpg"))
        bg= Label(self.root,image=self.bg)
        bg.place(x=0,y=0,relwidth=1,relheight=1)
        self.login_b=ImageTk.PhotoImage(Image.open("C:/Users/User pc/Documents/Mini Project/button images/button_login (3).png"))
        log_btn=Label(self.root,image=self.login_b)
        log_btn.place(x = 400, y = 200, height = 400, width = 800)
        self.regs_b=ImageTk.PhotoImage(Image.open("C:/Users/User pc/Documents/Mini Project/button images/button_sign-up (1).png"))
        #reg_btn=Label(self.root,image=self.reg_btn)
        #reg_btn.place(x=175, y=400, height = 75, width = 200)
        self.pass_b=ImageTk.PhotoImage(Image.open("C:/Users/User pc/Documents/Mini Project/button images/button_forgot-password (1).png"))
