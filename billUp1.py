...
class Bill_App:
    def __init__(self,root):
        ...
        search_no_btn=Button(F2,command=self.search_item,bg="sky blue",text="Search",fg="khaki",pady=10,width=8,bd=5,font="arial 15 bold").grid(row=1,column=1,padx=5,pady=5)

        F2A=LabelFrame(self.root,bd=10,relief=GROOVE, text="Widgets",font=("times new roman",15,"bold"),fg="gold",bg="white")
        F2A.place(x=20,y=380,width=280,height=140)

        btn_inventory=Button(F2A,command=self.openStock,text="Inventory",width=8,font=("times",15,"bold"),pady=8,bg="yellow",fg="red",bd=5).grid(row=1,column=1,pady=5,padx=5)
        Exit_btn=Button(F2A,command=self.root.destroy,bg="Blue",text="Exit",fg="khaki",pady=8,width=8,bd=5,font="times 15 bold").grid(row=1,column=2,padx=5,pady=5)
        #============Item Details===============#
        ...
        search_name_btn=Button(F3,command=self.add_item,bg="sky blue",text="Add",fg="khaki",pady=15,width=11,bd=5,font="arial 15 bold").grid(row=4,column=1,padx=5,pady=5)
        ...
        btn_F.place(x=730,width=530,height=105)

        total_btn=Button(btn_F,command=self.find_bill,bg= "blue",text="Total",fg="khaki",pady=12,width=9,bd=5,font="arial 15 bold").grid(row=0,column=0,padx=12,pady=5)
        GBill_btn=Button(btn_F,command=self.bill_area,bg="Blue",text="Generate Bill",fg="khaki",pady=12,width=14,bd=5,font="arial 15 bold").grid(row=0,column=1,padx=12,pady=5)
        Clear_btn=Button(btn_F,command=self.clear,bg="Blue",text="Clear",fg="khaki",pady=12,width=9,bd=5,font="arial 15 bold").grid(row=0,column=2,padx=12,pady=5)
