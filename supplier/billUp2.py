...
class Bill_App:
    def __init__(self,root):
        ...
        #============ ALL IMAGES ============#
        self.ttotal = ImageTk.PhotoImage(file="F:/supplier/button_images/total.png")
        self.Gen_bill=ImageTk.PhotoImage(file="F:/supplier/button_images/gen.png")
        self.Clear_b=ImageTk.PhotoImage(file="F:/supplier/button_images/clear.png")
        self.inventory_b=ImageTk.PhotoImage(file="F:/supplier/button_images/inventory.png")
        self.exit_b=ImageTk.PhotoImage(file="F:/supplier/button_images/exit.png")
        self.search_b=ImageTk.PhotoImage(file="F:/supplier/button_images/search.png")
        self.add_b=ImageTk.PhotoImage(file="F:/supplier/button_images/add.png")
        #=============Variables==================#
        #=========Search Field=============#
